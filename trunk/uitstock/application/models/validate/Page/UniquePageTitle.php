<?php
/**
	 * Class        : Unique Page Title
	 * Description  : Validate
	 * Author       : Vita - Nguyen Ngoc Linh
	 * Student ID   : 07520194
	 * Faculty      : IS
	 */
class Cloud_Validate_UniquePageTitle extends Zend_Validate_Abstract
{
	...
	public function isValid($value, $context = null)
	{
		...
		$page = $this->_mapper->getPageByTitle($value, $component_id, $currentPage);
