<?php
/**
	 * Class        : Unique Player Email
	 * Description  : Validate
	 * Author       : Vita - Nguyen Ngoc Linh
	 * Student ID   : 07520194
	 * Faculty      : IS
	 */
class Cloud_Validate_UniquePlayerEmail extends Zend_Validate_Abstract
{
	...
	public function isValid($value, $context = null)
	{
		...
		$player = $this->_mapper->getPlayerByEmail($value, $currentPlayer);
